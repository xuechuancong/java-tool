 ...
 * @date 2017-05-03
 */
public class SpringBootContextHolder implements ApplicationContextAware, DisposableBean {

    private static ApplicationContext applicationContext = null;

    private static Logger logger = LoggerFactory.getLogger(SpringBootContextHolder.class);
    ...
    public void destroy() throws Exception {
        SpringBootContextHolder.clearHolder();
    }
